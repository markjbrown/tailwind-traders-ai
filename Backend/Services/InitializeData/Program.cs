    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var context = serviceProvider.GetRequiredService<ProfileContext>();

                Log.Information("Seeding database");
                var seed = serviceProvider.GetRequiredService<ProfileContextSeed>();
                seed.SeedInternalAsync(context, @"D:\Projects\Microsoft\Code\TailwindTraders\Backend\Services\Tailwind.Traders.Profile.Api").Wait();
            }
            catch (Exception e)
            {
