...
using System;
using Tailwind.Traders.Profile.Api.Controllers;
...
namespace Tailwind.Traders.Profile.Api.Tests
{
    public class ApiHost
    {
        ...
        public void Initialize(string cloudPlatform, Action<IServiceCollection> overrideRegistration = null)
        {
            var hostBuilder = new HostBuilder()
               .ConfigureWebHost(builder =>
               {
                   ...
                   builder.ConfigureAppConfiguration((context, b) =>
                   {
                       ...
                       context.HostingEnvironment.ApplicationName = typeof(ProfileController).Assembly.GetName().Name;
                   });
            ...
            Client.DefaultRequestHeaders.Add(BasicAuthenticationHandler.AuthorizationHeaderName, "scott@me.com");
        }
